...
def snap(**kw):
    base=dict(price=Decimal("100"),ema_fast=Decimal("105"),ema_slow=Decimal("100"),volatility=Decimal("0.02"),spread_bps=Decimal("5"),volume_ratio=Decimal("1"),drawdown_pct=Decimal("0")); base.update(kw); return MarketSnapshot(**base)
