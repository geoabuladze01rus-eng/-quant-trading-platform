...
from execution.exchange_adapter import NormalizedOrder, NormalizedOrderResult, OrderSide, OrderType
class BinanceAdapter:
    ...
    async def order_status(self,exchange_order_id:str)->NormalizedOrderResult:
        raw=await self.client.get_order(orderId=exchange_order_id); from decimal import Decimal
